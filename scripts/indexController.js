define("indexController", ["validationService", "changeHtmlService", "startGameService",
    ...
    function (validationService, changeHtmlService, startGameService,
        ...
        function changeNameDivToGameDiv() {
            validationService.isFormValid() ? changeHtmlService.changeNameDivToGameDiv() : alert("Źle wypełniony formularz");
        };
        ...
        function validateGameOver() {
            ...
            if (isWinner || isNineMoves(gameHistory)) {
                endGameService.endGame();
                turnAndStatisticsService.setTurnForNoOne();
        ...
        function isNineMoves(gameHistory) {
            return gameHistory.length === 10;
        }
    });